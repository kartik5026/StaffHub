...
function OverView() {
    ...
    async function showUser() {
        const res = await axios.get("https://staffhub-o6z3.onrender.com/overview", { withCredentials: true });
    ...
    async function clearCookies(){
        const res = await axios.get("https://staffhub-o6z3.onrender.com/logout",{withCredentials:true});
        alert("Logged Out");
    }
    ...
    return (
        <div className="min-w-[80vw] text-center mx-auto">
            ...
            {user === 'failed' ?
                <div>
                    <form action="https://staffhub-o6z3.onrender.com/login" method="post">
